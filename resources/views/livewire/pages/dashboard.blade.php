<div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
        ...
        <div class="rounded-2xl border p-5 flex items-start gap-4"
            style="background-color: #f0fdf4; border-color: #bbf7d0; border-left: 12px solid #22c55e;">
            <div class="shrink-0 mt-0.5 w-9 h-9 rounded-xl flex items-center justify-center" style="background-color: #dcfce7;">
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="#22c55e" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
            </div>
            <div>
                <p class="font-bold text-green-800 text-x">Residence Verified</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div class="lg:col-span-3 space-y-1">
                ...
                <div class="space-y-3">
                    ...
                    <div class="rounded-2xl bg-white border shadow-sm p-5 flex items-center justify-between gap-3"
                        style="border-color: #e5e7eb; border-left: 12px solid {{ $borderColor }};">
                        <div class="flex-1 min-w-0">
                            <p class="font-bold text-base truncate" style="color: #33333B;">
                                {{ $app->scholarship->title }}
                            </p>
                            <p class="text-xs mt-0.5" style="color: #8B7D7B;">
            ...
            <div class="lg:col-span-2 space-y-1">
                ...
                <div class="space-y-3">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 hover:shadow-md hover:border-blue-100 transition-all duration-150">
                        <div class="flex gap-3">
                            <div class="w-1 self-stretch rounded-full flex-shrink-0" style="background-color: #1D74E3;"></div>
                            <div class="flex-1 min-w-0">
                                <h3 class="font-bold text-base leading-snug" style="color: #33333B;">
                                    {{ $announcement->title }}
                                </h3>
                                <p class="text-sm mt-1 leading-relaxed" style="color: #1B1A1C;">
                                    {{ $announcement->body }}
                                </p>
                                <div class="flex items-center gap-2 mt-2.5 text-xs" style="color: #8B7D7B;">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="rounded-2xl bg-white border border-gray-100 shadow-sm p-5 hover:shadow-md hover:border-blue-100 transition-all duration-150 flex flex-col justify-between">
                    <div>
                        <p class="font-bold text-base" style="color: #33333B;">{{ $scholarship->title }}</p>
