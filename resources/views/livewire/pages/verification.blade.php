            ...
            <div>
                ...
                @if ($valid_id)
                    <div class="mt-2 flex items-center justify-between gap-2 bg-green-50/60 border border-green-100 rounded-lg py-1.5 px-2.5">
                        ...
                        <button type="button" wire:click="removeFile('valid_id')"
                            class="shrink-0 text-[#AA9A98] hover:text-red-500 transition-colors ml-2" title="Remove file">
                ...
                @error('valid_id')
                    <p class="text-red-500 text-xs mt-1.5 pl-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                @if ($proof_of_residency)
                    <div class="mt-2 flex items-center justify-between gap-2 bg-green-50/60 border border-green-100 rounded-lg py-1.5 px-2.5">
                        ...
                        <button type="button" wire:click="removeFile('proof_of_residency')"
                            class="shrink-0 text-[#AA9A98] hover:text-red-500 transition-colors ml-2" title="Remove file">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                            </svg>
            ...
            <div>
                ...
                @if ($birth_certificate)
                    <div class="mt-2 flex items-center justify-between gap-2 bg-green-50/60 border border-green-100 rounded-lg py-1.5 px-2.5">
                        ...
                        <button type="button" wire:click="removeFile('birth_certificate')"
                            class="shrink-0 text-[#AA9A98] hover:text-red-500 transition-colors ml-2" title="Remove file">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                            </svg>
