                    ...
                    <tr class="border-b border-gray-100 dark:border-zinc-700 hover:bg-gray-50/50 dark:hover:bg-zinc-700/50 transition duration-150">
                        ...
                        <td class="p-4">
                            @if ($admin->verification_status === 'verified')
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-green-50 text-green-700 dark:bg-green-950/30 dark:text-green-400">
                                    Active
                                </span>
                            @else
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-gray-100 text-gray-700 dark:bg-zinc-700 dark:text-zinc-300">
