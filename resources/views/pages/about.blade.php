...
<div class="font-sans-clean bg-gray-50/50 min-h-screen pb-24 selection:bg-blue-500 selection:text-white">
    {{-- HERO --}}
    <section class="relative overflow-hidden  bg-blue-900 py-24 px-4 text-center text-white">
        <!-- Background Accents -->
        ...
        <div class="relative z-10 max-w-3xl mx-auto">
            ...
            <h1 class="font-serif-elegant text-4xl md:text-6xl font-black tracking-tight mb-4 drop-shadow-sm">About Our Program</h1>
    ...
    <section class="max-w-5xl mx-auto px-4 py-16 space-y-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            {{-- Mission --}}
            <div class="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-md hover:border-blue-100 transition-all duration-300">
            ...
            {{-- Vision --}}
            <div class="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-md hover:border-amber-100 transition-all duration-300">
        ...
        <div x-data="{ checkedCount: 0 }" id="eligibility-card" class="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm transition-all duration-300">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-4 border-b border-gray-50">
                ...
                <div id="eligibility-status" class="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-gray-100 text-gray-600 text-xs font-semibold transition-all duration-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                {{-- Requirement 1 --}}
                <label class="eligibility-item flex items-start gap-3.5 p-4 rounded-xl bg-gray-50/50 border border-gray-100 cursor-pointer hover:bg-blue-50/20 hover:border-blue-200 transition-all duration-200 group">
                    <input type="checkbox" onchange="updateEligibility()" class="mt-1 rounded text-blue-600 focus:ring-blue-500 border-gray-300 w-4 h-4 transition">
                    <span class="text-gray-700 text-sm md:text-base font-medium group-hover:text-gray-900 transition-colors">Must be a verified and registered resident of the barangay.</span>
                </label>

                {{-- Requirement 2 --}}
                <label class="eligibility-item flex items-start gap-3.5 p-4 rounded-xl bg-gray-50/50 border border-gray-100 cursor-pointer hover:bg-blue-50/20 hover:border-blue-200 transition-all duration-200 group">
                    <input type="checkbox" onchange="updateEligibility()" class="mt-1 rounded text-blue-600 focus:ring-blue-500 border-gray-300 w-4 h-4 transition">
                    <span class="text-gray-700 text-sm md:text-base font-medium group-hover:text-gray-900 transition-colors">Must satisfy the explicit eligibility thresholds of the specific program.</span>
                </label>

                {{-- Requirement 3 --}}
                <label class="eligibility-item flex items-start gap-3.5 p-4 rounded-xl bg-gray-50/50 border border-gray-100 cursor-pointer hover:bg-blue-50/20 hover:border-blue-200 transition-all duration-200 group">
                    <input type="checkbox" onchange="updateEligibility()" class="mt-1 rounded text-blue-600 focus:ring-blue-500 border-gray-300 w-4 h-4 transition">
                    <span class="text-gray-700 text-sm md:text-base font-medium group-hover:text-gray-900 transition-colors">Must cleanly organize and submit all required data within deadline structures.</span>
                </label>

                {{-- Requirement 4 --}}
                <label class="eligibility-item flex items-start gap-3.5 p-4 rounded-xl bg-gray-50/50 border border-gray-100 cursor-pointer hover:bg-blue-50/20 hover:border-blue-200 transition-all duration-200 group">
                    <input type="checkbox" onchange="updateEligibility()" class="mt-1 rounded text-blue-600 focus:ring-blue-500 border-gray-300 w-4 h-4 transition">
                    <span class="text-gray-700 text-sm md:text-base font-medium group-hover:text-gray-900 transition-colors">Must not hold concurrent scholarship slots within different local funds.</span>
                </label>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
            <div class="text-center md:text-left mb-10">
                <h2 class="font-serif-elegant text-2xl font-bold text-gray-800 flex items-center justify-center md:justify-start gap-2.5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 relative">
                ...
                <div class="text-center relative group">
                    <div class="w-12 h-12 rounded-2xl bg-blue-600 flex items-center justify-center mx-auto mb-4 text-white font-bold text-lg shadow-md shadow-blue-200 group-hover:bg-blue-700 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                        1
                    </div>
                    <h3 class="font-serif-elegant font-bold text-gray-800 mb-1.5 text-base">Register</h3>
                    <p class="text-xs text-gray-500 px-3 leading-relaxed">Securely build out your unique portal login credentials profile.</p>
                </div>
                ...
                <div class="text-center relative group">
                    ...
                    <p class="text-xs text-gray-500 px-3 leading-relaxed">Upload official proof of residency data markers to desk clerks.</p>
                </div>
                ...
                <div class="text-center relative group">
                    ...
                    <p class="text-xs text-gray-500 px-3 leading-relaxed">Select an operational grant index and submit your requirements.</p>
                </div>
                ...
                <div class="text-center relative group">
                    ...
                    <p class="text-xs text-gray-500 px-3 leading-relaxed">Track assessment approvals and get your disbursement notifications.</p>
                </div>
            </div>
        </div>
        ...
        <div class="text-center pt-4">
            <a href="{{ route('scholarships.index') }}"
                ...
                <!-- Arrow Right Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 transition-transform duration-300 group-hover:translate-x-1.5">
...
<script>
    function updateEligibility() {
        ...
        if (checkedCount === 4) {
            statusBadge.className = "inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-green-500 text-white text-xs font-semibold transition-all duration-300 animate-bounce";
            checkedText.innerText = "🎉 You Look Eligible!";
            mainCard.classList.add('border-green-200', 'ring-2', 'ring-green-500/10');
        } else if (checkedCount > 0) {
            statusBadge.className = "inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-blue-50 text-blue-600 text-xs font-semibold transition-all duration-300";
            mainCard.classList.remove('border-green-200', 'ring-2', 'ring-green-500/10');
        } else {
            statusBadge.className = "inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-gray-100 text-gray-600 text-xs font-semibold transition-all duration-300";
            mainCard.classList.remove('border-green-200', 'ring-2', 'ring-green-500/10');
        }
    }
</script>
