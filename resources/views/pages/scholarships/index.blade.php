                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border hover:shadow-md transition-all duration-200 hover:border-blue-100"
                    ...
                    <div class="flex flex-col md:flex-row md:items-start gap-4">
                        ...
                        <div class="flex flex-col items-end justify-between gap-4 md:min-w-[140px]">
                            ...
                            {{-- Apply Button --}}
                            @if($scholarship['already_applied'])
                            <a href="{{ route('scholarships.show', $scholarship['id']) }}" wire:navigate
                                class="flex items-center gap-1.5 text-sm font-semibold px-4 py-2.5 rounded-xl transition hover:opacity-80"
