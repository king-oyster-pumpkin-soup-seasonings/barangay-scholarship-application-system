                ...
                <div class="lg:col-span-2 space-y-6">
                        ...
                        <h2 class="text-xl font-bold mb-4 flex items-center gap-3"
                            ...
                            <div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-4 h-4" style="color: #1D74E3;">
                            ...
                            <ul class="space-y-3">
                                @foreach ($eligibility as $req)
                                    <li class="flex items-start gap-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="2" stroke="currentColor" class="w-5 h-5 mt-0.5 flex-shrink-0"
                                            style="color: #1D74E3;">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="m4.5 12.75 6 6 9-13.5" />
                                        </svg>
                                        <div>
                                            <span class="text-sm font-medium" style="color: #1B1A1C;">
                                                {{ $req['label'] }}
                                            </span>
                                            @if ($req['is_required'])
                            ...
                            <ul class="space-y-3">
                                @foreach ($generalDocs as $req)
                                    <li class="flex items-center gap-3 p-3 rounded-xl" style="background-color: #F5F0E8;">
                                        ...
                                        <div class="flex-1">
                                            <span class="text-sm font-medium" style="color: #33333B;">
                                                {{ $req['label'] }}
                                            </span>
                                        </div>
                                        @if ($req['is_required'])
                    ...
                    @php
                        $additionalFields = array_filter(
                            $requirements,
                            fn($r) => $r['category'] === 'additional_field',
                        );
                    @endphp
                        ...
                        <div class="bg-white rounded-2xl p-8 shadow-sm border" style="border-color: #F0EDE8;">
                            ...
                            <ul class="space-y-3">
                                @foreach ($additionalFields as $req)
                                    <li class="flex items-start gap-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mt-0.5 flex-shrink-0"
                                            style="color: #AA9A98;">
                                            <path stroke-linecap="round" stroke-linejoin="round"
